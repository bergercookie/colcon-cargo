...
def test_spell_check():
    ...
    try:
        ...
        pytest.skip("Skipping spell checking tests since 'enchant' was not found")
    ...
    try:
        Run(
            ...
            + [str(p) for p in (Path(__file__).parents[1] / "test").glob("**/*.py")]
        )
...
def test_spell_check_word_list():
    ...
    assert lines == sorted(lines), "The word list should be ordered alphabetically"
